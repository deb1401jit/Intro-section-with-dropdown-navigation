...
dropdownButton.forEach(elm => {
  elm.addEventListener('click',()=>{
    ...
    if(dropdownList.classList.contains("dropdown-active")){
      ...
      elm.classList.remove("nav-active-button");
      elm.children[0].src = "images/icon-arrow-down.svg";
    } else {
      dropdownList.classList.add("dropdown-active");
      elm.classList.add("nav-active-button");
      elm.children[0].src = "images/icon-arrow-up.svg";
    }
  });
});